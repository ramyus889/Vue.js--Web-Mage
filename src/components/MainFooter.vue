<script setup></script>
<template>
  <div class="mt-[40px] flex place-content-center">
    <div class="flex flex-col gap-2">
      <div class="text-center leading-[84px]">
        <div data-aos="fade-up" data-aos-delay="100" class="text-[72px] font-bold">
          Give your data team
        </div>
        <div
          data-aos="fade-up"
          data-aos-delay="300"
          class="text-[72px] font-bold bg-gradient-to-r bg-clip-text text-transparent from-[#765CED] to-[#31AAFD]"
        >
          magical powers
        </div>
      </div>
      <div class="flex place-content-center gap-10 items-center text-[64px] mt-[64px]">
        <div class="">
          <div data-aos="fade-right" data-aos-delay="400" class="relative group">
            <div class="relative w-48 h-16 opacity-90 overflow-hidden rounded-xl bg-black z-10">
              <div
