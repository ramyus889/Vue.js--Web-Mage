  ...
  <div class="flex place-content-center px-5">
    <div class="flex flex-col gap-[32px]">
      ...
      >
        ...
        by Mage next year!
        <div class="flex flex-col gap-1 text-[16px] leading-3 mt-[53px]">
          <div class="">Zach Wilson</div>
      ...
      <div class="flex gap-[32px]">
        ...
        >
          ...
          <div class="font-semibold pt-[27px]">
      ...
      >
        ...
        This is NOT something found in Airflow, Prefect, or Dagster.
        <div class="flex flex-col gap-1 text-[16px] leading-3 mt-[53px]">
          <div class="">Daniel Beach</div>
      ...
      <div class="flex gap-[32px]">
        ...
        >
          ...
          experience, <span class="text-[#885EFF] font-bold">saving time</span> in development.
          <div class="mt-[26px]">
        ...
        >
          ...
          start using Mage as one of our<span class="text-[#FFCC19] font-bold">
            daily data tools</span
          >.

          <div class="flex flex-col gap-1 text-[16px] leading-3 mt-[59px]">
            <div class="">Juan Mantegazza</div>
            <div class="">Lead Data Engineer @ Zubale</div>
          </div>
        </div>
      </div>
      <div class="flex gap-[32px]">
        ...
        >
          ...
          <div class="flex flex-col gap-1 text-[16px] leading-3 mt-[103px]">
            <div class="">Petrica Leuca</div>
            <div class="">Freelance Data Engineer</div>
          </div>
        </div>
        <div
          data-aos="fade-left"
        ...
        >
          ...
          <div class="flex flex-col gap-1 text-[16px] leading-3 mt-[67px]">
            <div class="">Ian Yu</div>
            <div class="">Machine Learning Engineer @ GroupBy Inc.</div>
          </div>
        </div>
      </div>
    </div>
