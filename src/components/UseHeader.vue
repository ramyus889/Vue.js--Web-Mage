...
<template>
  <div class="fixed top-0 left-0 right-0 z-[1000]">
    <div class="flex justify-between items-center px-[24px] py-[8px] bg-[#111113]">
      <svg
        height="24"
        viewBox="0 0 831 208"
        width="121.76923076923077"
        xmlns="http://www.w3.org/2000/svg"
        class="LogoGradientWithName__SVGStyle-gq8qmd-0 ituzrM"
      >
        <g clip-path="url(#0.7974735488032427)">
          <path
            opacity=".4"
            d="M217.47.478516h58.443L167.631 207.911h-58.443L217.47.478516z"
            fill="url(#0.6979700877670738)"
          ...
          <path
            ...
            fill="url(#0.6597842174191955)"
            class="LogoGradientWithName__PathStyle-gq8qmd-1"
          ></path>
          <path
            d="M217.484.478516h58.444V207.911h-58.444V.478516z"
            fill="url(#0.5977290288092028)"
            class="LogoGradientWithName__PathStyle-gq8qmd-1"
          ></path>
        </g>
        <defs>
          <linearGradient
            id="0.6979700877670738"
            x1="100.593"
            y1=".478497"
            x2="256.361"
            y2="9.77804"
          ...
          <clipPath id="0.7974735488032427">
            <path
              fill="#fff"
      ...
      <div class="flex gap-5 items-center">
        <div class="flex">
          ...
          <Button text severity="secondary" class="font-bold">Blog</Button>
        </div>
        <div class="flex gap-5 items-center">
          <div class="relative group">
            <div class="relative w-48 h-9 opacity-90 overflow-hidden rounded-xl bg-black z-10">
              <div
              ...
              >
                <button
                  name="text"
                  class="input font-semibold text-lg h-full opacity-90 w-full px-8 rounded-xl bg-black"
                >
                  Get Started
                </button>
              </div>
